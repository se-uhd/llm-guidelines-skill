...
3. **Consult `../../shared/scope.md`** to confirm the work is in scope (LLM use that materially affects the research method or its outcomes, not just LLM-assisted writing).
