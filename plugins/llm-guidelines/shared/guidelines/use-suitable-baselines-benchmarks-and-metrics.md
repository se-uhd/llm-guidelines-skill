...
The metric *pass@k* reports the likelihood that a model correctly completes a code snippet at least once within *k* attempts. Originally introduced by Kulal et al. (2019) (Kulal et al. 2019) as the success rate within a budget of *B* program attempts (the role now played by *k* in *pass@k*) and popularized by M. Chen et al. (2021) (M. Chen et al. 2021), it ranges from 0 (no correct solution in *k* tries) to 1 (at least one correct solution), with correctness typically defined by passing test cases.
