...
- **should** Report fingerprints/checksums and additional model properties where available; for commercial tools, openly acknowledge their reproducibility limits ([Model Version](./guidelines/report-model-version-configuration-and-customizations.md)).
