...
plugins/
  llm-guidelines/
    ...
    skills/
      llm-guidelines/
        SKILL.md                  router with shared frontmatter, mode-
                                  selection, and shared constraints
        references/
          explore.md              explore-mode procedure
          review.md               review-mode procedure
          guidelines/             eight standalone guideline files
          study-types/            seven study-type files plus parent
                                  groupings
